...
flags.DEFINE_string('load_network', os.path.join(DEFAULT_LOG_DIR, 'networks'), "load saved dqn_agent network.")
flags.DEFINE_string('load_memory', os.path.join(DEFAULT_LOG_DIR, 'memory'), "load saved replay memory.")
...
flags.DEFINE_integer('dummy_vehicles', 1, "number of vehicles using dummy agent")
flags.DEFINE_integer('dqn_vehicles', 7999, "number of vehicles using dqn agent")
...
flags.DEFINE_integer('days', 5, "simulation days")
